...
T = readtable('paths/local_path_log1/path_pts.csv');
T1 = readtable('paths/local_path_log1/control_pts.csv');
T2 = readtable('paths/local_path_log1/waypoints.csv');
T3 = readtable('paths/local_path_log1/orig_waypoints.csv');
...
plot(path_pts(:,1),path_pts(:,2),'-k','linewidth',2.5); % plot the reference trajectory