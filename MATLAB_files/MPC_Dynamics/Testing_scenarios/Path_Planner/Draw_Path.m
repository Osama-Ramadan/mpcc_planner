...
T = readtable('paths/Ware_house/local_path_log13/path_pts0.csv');
T1 = readtable('paths/Ware_house/local_path_log13/control_pts_orig0.csv');
T2 = readtable('paths/Ware_house/local_path_log13/waypoints_orig0.csv');
T3 = readtable('paths/Ware_house/local_path_log13/waypoints0.csv');
T4 = readtable('paths/Ware_house/local_path_log13/path_pts_orig0.csv');
