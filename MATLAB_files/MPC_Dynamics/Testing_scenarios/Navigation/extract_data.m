...
bagreader = ros2bag('bag_files/Map1_RTest2');
...
T = readtable('bag_files/Map1_RTest2/local_path_log/path_pts.csv');
T1 = readtable('bag_files/Map1_RTest2/local_path_log/control_pts.csv');
T2 = readtable('bag_files/Map1_RTest2/local_path_log/waypoints.csv');
T3 = readtable('bag_files/Map1_RTest2/local_path_log/orig_waypoints.csv');
...
Draw_Scenario(vehicle_traj,vehicle_pred_traj_b,mpcc_cmd,N,mpcc_time_ctr,waypoints,path_pts,rob_diam,obst_diam,map,bounds, obst_pred_traj_b)
