...
Rt = 0.5;
xF_F = xF + Rt*cos(psi); % x position front of front tire
yF_F = yF + Rt*sin(psi); % y position rear of front tire
xF_R = xF - Rt*cos(psi); % x position front of front tire
yF_R = yF - Rt*sin(psi); % y position rear of front tire

xR_F = xR + Rt*cos(psi-delta); % x position front of rear tire
yR_F = yR + Rt*sin(psi-delta); % y position rear of rear tire
xR_R = xR - Rt*cos(psi-delta); % x position front of rear tire
yR_R = yR - Rt*sin(psi-delta); % y position rear of rear tire
